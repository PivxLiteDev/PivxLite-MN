#!/bin/bash
# PivxLite Masternode Setup Script V2.1.0 for Ubuntu 20.04 LTS
#
...
wget https://github.com/PivxLiteDev/PivxLite/releases/download/v2.1.0/pivxl-2.1.0-ubuntu-20.04.tar.gz
tar -xzvf pivxl-2.1.0-ubuntu-20.04.tar.gz
